    ...
    public function add_new_realm_user($order_data, $class, $pass, $comment, $email){
        ...
        switch ($apiName){
            ...
            case 'ionline' :
                        ...
                        break;
            default : $result = $this->defaultResponseData;
    ...
    */
     ...
     */
     public function restore_account($order_data){
         ...
         switch ($api_data['api_name']){
             ...
             case 'isdsl'    : $result = $this->restore_account_isdsl($order_data); break;
             case 'ionline'  : $result = $this->restore_account_ionline($order_data); break;
             default : $result = $this->defaultResponseData;
                       $result['message'] = "Unsupported API name ('default' case)";
                       break;
    ...
    public function get_user_info($order_data){
        ...
        switch ($api_data['api_name']){
            ...
            case 'isdsl'    : $result = $this->get_user_info_isdsl($order_data); break;
            case 'ionline'  : $result = $this->get_user_info_ionline($order_data); break;
            default : $result = null;
    ...
    public function delete_user_from_realm($order_data){
        ...
        switch ($api_data['api_name']){
            ...
            case 'isdsl': $result = $this->delete_user_from_realm_isdsl($order_data); break;
            case 'ionline' : $result = $this->delete_user_from_realm_ionline($order_data); break;
            default : $result = null;
    ...
    public function set_class_to_user($order_data, $new_class){
        ...
        switch ($api_data['api_name']){
            ...
            case 'isdsl': $result = $this->set_class_to_user_isdsl($order_data, $classMapperRow[$apiName]['name']); break;
            case 'ionline' : $result = $this->set_class_to_user_ionline($order_data, $classMapperRow[$apiName]['id']); break;
            default : $result = $this->defaultResponseData;
                $result['message'] = "Unsupported API name ('default' case)";
                break;
    ...
    public function get_all_accounts($apiName = 'ionline', $params = null){
        ...
        switch ($apiName){
            ...
            case 'isdsl':
            case 'ionline' : $result = $this->get_all_accounts_isdsl($params); break;
    ...
    public function apply_force_map_validation($originalClass, $apiName, 
                                                        &$classMapRow, &$classValidation)
    {

        // check corresponding flags and variables, 
        // if some statement is FALSE -> left $classMapRow and $classValidation unchanged
        if (!isset($this->forceClassMapValidation[$apiName]) 
    ...
    public function get_session_info($order_data, $options = null){
        ...
        switch ($api_data['api_name']){
            ...
            case 'isdsl': $result = $this->get_session_info_isdsl($order_data, $options); break;
            case 'ionline' : $result = $this->get_session_info_ionline($order_data, $options); break;
    ...
    public function get_activity_info($order_data, $options){
        ...
        switch ($api_data['api_name']){
            ...
            case 'isdsl': $result = $this->get_activity_info_isdsl($order_data,$options); break;
            case 'ionline' : $result = $this->get_activity_info_ionline($order_data, $options); break;
            // if no realm like in LTE-A, but must be remaked
            default: $result = $this->get_activity_info_isdsl($order_data,$options); break;
        }
    ...
    public function set_pending_update_isdsl($order_data, $class, $date){
        ...
        switch ($date){
            ...
            default  : $result = $this->is_classes->set_pending_update_with_handler($order_data, $class); break;
    ...
    */
    ...
    public function change_account_comment($order_data, $comment){
        ...
        switch ($api_data['api_name']){
            ...
            case 'isdsl' : $result = $this->change_account_comment_isdsl($order_data, $comment); break;
            case 'ionline' : $result = $this->change_account_comment_ionline($order_data, $comment); break;
            default : $result = $this->defaultResponseData;
                $result['message'] = "Unsupported API name ('default' case)";
                break;
...
$payload = json_encode( $data);
        ...
        $username='api@openwebmobile.co.za';$password='oC3JRkyQ7q==123-';
        $ch = curl_init($host);
