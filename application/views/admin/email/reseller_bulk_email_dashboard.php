...
<?php if (isset($single_batch) && !empty($single_batch)) { ?>
    <div class="row">
        <div class="col-md-12">
            <a href="<?php echo base_url('index.php/admin/reseller_bulk_email_dashboard') ?>" class="btn btn-primary" style="float: right;">View Batch List</a>
        </div>
            ...
            <?php if (isset($batch_data) && !empty($batch_data)) { ?>
                <?php foreach ($batch_data as $key => $value) { ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $value['status'] ?></td>
                        <td><a href="<?php echo base_url('index.php/admin/reseller_bulk_email_dashboard?batch_id=') . $value['batch_id'] ?>">Batch Details</a></td>
                    </tr>
                <?php } ?>
            <?php } ?>
        </tbody>
