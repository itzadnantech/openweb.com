                    ...
                    switch (res.code) {
                        case 'success':
                            ...
                            setTimeout(function() {
                                ...
                                window.location.href = 'https://home.openweb.co.za/index.php/admin/client_bulk_email_dashboard';
                            }, 3000)
                            break;
                        case 'warning':
                            $("#couter_mod").modal("hide");
...
if (isset($email_detail) && !empty($email_detail)) {
    ...
    echo form_open('admin/bulk_mail', array('class' => 'form-horizontal', 'id' => 'edit_email_form'));
            ...
            <div class="control-group">
                <div class="controls">
                    <div style="text-align: center;">
                        <input id="subm" type="submit" class="btn btn-large btn-primary" value="Send" name="">
                    </div>
                </div>
            </div>
        </fieldset>
