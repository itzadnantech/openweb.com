<script>
    function check(){
        ...
        if(r){
            window.location.href = "/index.php/admin/all_subcategory_reseller/"+r;
        }else{
            return false;
        }
    }
</script>
<h3><?php echo $subcategory_type ?>Reseller Subcategory</h3>
<?php
echo form_open('admin/all_subcategory_reseller', array('class' => '','id' => 'form_filter_product')); ?>
