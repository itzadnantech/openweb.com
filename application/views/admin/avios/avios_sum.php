...
<legend>Avios Awards</legend>
    <!-- Tab links -->
    <div class="tab">
        <button class="tablinks" id="prep_tab" onclick="goLink('Prepared')">Prepared</button>
        <button class="tablinks" id="sent_tab" onclick="goLink('Sent')">Sent</button>
        <button class="tablinks active" id="sum_tab" onclick="goLink('summary')">Summary</button>
    </div>
