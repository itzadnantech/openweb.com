<div class="page-content">
    ...
    <div class="content">
        ...
        <div class="page-title">
            <h3>Topup your Mobile account instantly:</h3>
        </div>
        <p>Kindly select the Topup Plan you Mobile account you would like to topup with your credit card below. For EFT topups, kindly email <span id="a-email">admin@openweb.co.za</span></p>
                    ...
                    <?php foreach ($telkom_plan as $tp) : ?>
                        <td>
                            <div>
                                ...
                                <p><button type="button" class="btn btn-info btn-lg telkom-orderknowbtn" data-order-id="<?= $order_id; ?>" data-topup-id="<?= $tp['topup_id'] ?>" data-toggle="modal" data-target="#myModal">Order Now</button></p>
                            </div>
                        </td>
                    <?php endforeach; ?>
                </tr>
