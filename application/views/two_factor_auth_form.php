    ...
    <div class="container">
        ...
        <div class="row column-seperation">
            <div class="col-md-5 col-md-offset-4">
                <br>
                <form action="/login/validate_two_factor_auth" class="login-form validate" id="login-form" method="post" name="login-form">
                    <div class="row">
                        <div class="form-group col-md-10">
                            <label class="form-label">Code</label>
                            <input class="form-control" id="txtusername" name="code" type="text" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-10">
